...
static_transform Eigen::Quaternion.from_angle_axis(Math::PI, Eigen::Vector3.UnitX),
    'body' => 'ptu_pan_plate'
...
static_transform Eigen::Quaternion.from_angle_axis(TILT_PLATE_TO_MOUNTING_BRACKET_ANGLE, Eigen::Vector3.UnitZ),
    'ptu_tilt_plate' => 'ptu_mounting_bracket_axis'

static_transform Eigen::Vector3.new(0, -0.103, -0.078), Eigen::Quaternion.from_angle_axis(Math::PI/2, Eigen::Vector3.UnitX),
    'ptu_mounting_bracket_axis' => 'ptu_mounting_bracket_plate'

static_transform Eigen::Vector3.new(0.5, 0.2, 0), Eigen::Quaternion.from_angle_axis(Math::PI/2, Eigen::Vector3.UnitY),
